...
//   const lockedFields = ["Full name", "Photo Profile", "Email"];

//   const [selections, setSelections] = useState(
//     Object.fromEntries(fields.map((f) => [f, "Mandatory"]))
//   );

//   const handleSelect = (field: string, value: string) => {
//     if (lockedFields.includes(field)) return; // prevent changing locked fields
...
//             >
//               <span className="text-m-regular text-neutral-90">{field}</span>
...
//                           " bg-white text-primary-main border-primary-main";
//                       else
//                         classes += " bg-gray-300 text-gray-600 border-gray-300";
//                     } else {
//                       classes +=
